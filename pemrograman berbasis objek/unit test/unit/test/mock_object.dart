...
void main() {
  group("BookService", () {
    ...
    test("Find book by id ferdi321", () {
      when(bookRepository.findById(argThat(startsWith("eko"))))
          .thenReturn(Book("Ferdi321", "Tutorial Dart", 100000));

      var book = bookService.find("ferdi321");
      expect(book, equals(Book("ferdi321", "Tutorial Dart", 100000)));
