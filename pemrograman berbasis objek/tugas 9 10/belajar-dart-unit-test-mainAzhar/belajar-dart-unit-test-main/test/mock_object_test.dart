...
void main() {
  group("BookService", () {
    ...
    test("Find book by id Azhar123", () {
      when(bookRepository.findById(argThat(startsWith("eko"))))
          .thenReturn(Book("Azhar123", "Tutorial Dart", 100000));

      var book = bookService.find("Azhar123");
      expect(book, equals(Book("Azhar123", "Tutorial Dart", 100000)));
